...
* Language Servers:
  - Fix: Erlang support now uses the maintained Erlang Language Platform (ELP) instead of the archived Erlang LS; Serena downloads a verified platform release when `elp` is not already on PATH (#771)
