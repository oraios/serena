...
* Language support:
  * **Add support for Haskell** via Haskell Language Server (HLS). Supports document symbols, go-to-definition, references, and cross-file navigation. Requires ghcup or HLS on PATH.
