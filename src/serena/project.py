...
class Project(ToStringMixin):
    ...
    def create_language_server_manager(self) -> LanguageServerManager:
        ...
        try:
            ...
            project_ls_specific_settings = {k: v for k, v in self.project_config.ls_specific_settings.items() if v}
            merged_ls_specific_settings = {**self.serena_config.ls_specific_settings, **project_ls_specific_settings}
