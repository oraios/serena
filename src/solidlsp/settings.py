...
class SolidLSPSettings:
    ...
    """
    ls_specific_settings: dict["LanguageServerKey", dict[str, Any]] = field(default_factory=dict)
    """
    ...
    def get_ls_specific_settings(self, ls_id: "LanguageServerKey") -> CustomLSSettings:
        """
