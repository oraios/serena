...
from murena.util.file_system import GitignoreParser, match_path
from murena.util.general import save_yaml
...
class MemoriesManager:
    def __init__(self, project_root: str):
        ...
        self._encoding = MURENA_FILE_ENCODING
...
class Project(ToStringMixin):
    ...
    def path_to_serena_data_folder(self) -> str:
        return os.path.join(self.project_root, MURENA_MANAGED_DIR_NAME)
