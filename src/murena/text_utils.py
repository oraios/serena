...
from murena.constants import DEFAULT_SOURCE_FILE_ENCODING
...
def search_text(
    ...
    if allow_multiline_match:
        ...
        # TODO: extremely inefficient! Since we currently don't use this option in MurenaAgent or LanguageServer,
