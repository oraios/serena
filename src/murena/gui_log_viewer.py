    ...
    def run_gui(self):
        ...
        try:
            ...
            if sys.platform == "win32":
                ...
                ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("oraios.murena")
            ...
            dashboard_path = Path(constants.MURENA_DASHBOARD_DIR)
