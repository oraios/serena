...
def autogen_about_intro_features():
    ...
    with open(Path(__file__).parent / "01-about" / "000_intro.md", "w", encoding="utf-8") as f:
        ...
        f.write(f"**{tagline}**\n\n")
        about_text = about_text.replace("resources/serena-block-diagram.png", "https://raw.githubusercontent.com/oraios/serena/readme-overhaul/resources/serena-block-diagram.png")
