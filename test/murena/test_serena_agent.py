...
from murena.config.murena_config import MurenaConfig, ProjectConfig, RegisteredProject
from murena.project import Project
from murena.tools import SUCCESS_RESULT, FindReferencingSymbolsTool, FindSymbolTool, ReplaceContentTool, ReplaceSymbolBodyTool
...
def serena_config():
    ...
    config = MurenaConfig(gui_log_window=False, web_dashboard=False, log_level=logging.ERROR)
...
@contextmanager
def project_file_modification_context(serena_agent: MurenaAgent, relative_path: str) -> Iterator[None]:
...
class TestMurenaAgent:
    ...
    def test_find_symbol(self, serena_agent: MurenaAgent, symbol_name: str, expected_kind: str, expected_file: str):
        agent = serena_agent
    ...
    def test_find_symbol_references(self, serena_agent: MurenaAgent, symbol_name: str, def_file: str, ref_file: str) -> None:
        agent = serena_agent
    ...
    def test_find_symbol_overloaded_function(self, serena_agent: MurenaAgent, name_path: str, num_expected: int):
        """
    ...
    def test_non_unique_symbol_reference_error(self, serena_agent: MurenaAgent, name_path: str, relative_path: str):
        """
    ...
    def test_replace_content_regex_with_wildcard_ok(self, serena_agent: MurenaAgent):
        """
    ...
    def test_replace_content_with_backslashes(self, serena_agent: MurenaAgent, mode: Literal["literal", "regex"]):
        """
    ...
    def test_replace_content_regex_with_wildcard_ambiguous(self, serena_agent: MurenaAgent):
        """
