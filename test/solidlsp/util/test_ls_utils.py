...
def test_get_relative_path_normalizes_windows_separators() -> None:
    """Relative paths should use forward slashes for cross-platform stability."""
    relative_path = PathUtils.get_relative_path("C:\\repo\\src\\main\\App.java", "C:\\repo")

    assert relative_path == "src/main/App.java"
