...
AL, Bash, C#, C/C++, Clojure, Dart, Elixir, Elm, Erlang, F#, Fortran, Go, Haskell, Java, Javascript, Julia, Kotlin, Lua, Markdown, Nix, Perl, PHP, Python, R, Ruby, Rust, Scala, Swift, TypeScript, YAML and Zig.
